...
from onadata.libs.utils.common_tags import (
    ...
    SUBMISSION_TIME, UUID, TAGS, NOTES, SITE, FS_STATUS, FS_UUID, FS_PROJECT_UUID, FS_SITE_IDENTIFIER, FS_SITE_NAME, FS_SITE_PHONE, FS_SITE_SUPERVISOR)
...
class ExportBuilder(object):
    ...
    EXTRA_FIELDS = [ID, UUID, SUBMISSION_TIME, INDEX, PARENT_TABLE_NAME,
                    ...
                    FS_STATUS, FS_SITE_IDENTIFIER, FS_SITE_NAME, FS_SITE_PHONE, FS_SITE_SUPERVISOR]
    ...
    def to_xls_export(self, path, data, username, id_string, filter_query):
        ...
        try:
            ...
            if __version__:
                submissions = fxf_form.project_form_instances.filter(version=__version__).select_related("site").values("form_status", "instance", "site", "site__name", "site__phone", "site__identifier")
            else:
                submissions =fxf_form.project_form_instances.select_related("site").values("form_status", "instance","site", "site__name", "site__phone", "site__identifier")
            ...
            if __version__:
                submissions = fxf_form.site_form_instances.filter(version=__version__).select_related("site").values(
                    "form_status", "instance", "site", "site__name", "site__phone", "site__identifier")
            else:
