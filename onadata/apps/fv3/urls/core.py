...
from onadata.apps.fv3.views import TeamsViewset, TeamFormViewset, OrganizationViewSet, supervisor_project_detail
...
urlpatterns = [
    ...
    url(r'^api/supervise-project-detail/(?P<pk>\d+)/$', supervisor_project_detail, name='supervisor_project_detail'),
