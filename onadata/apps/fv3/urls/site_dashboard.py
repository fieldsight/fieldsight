...
from onadata.apps.fv3.viewsets.SiteViewSet import SiteViewSet, site_map, SiteSubmissionsViewSet, SiteForms, \
    SiteCropImage, site_documents, site_recent_pictures, BlueprintsPostDeleteView, ZipSiteImages, SiteMetaAttributes
...
site_dashboard_urlpatterns = [
    ...
    url(r'^api/meta-attributes/(?P<pk>\d+)/$', SiteMetaAttributes.as_view(), name='sma'),
