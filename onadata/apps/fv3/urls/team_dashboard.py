...
from onadata.apps.fv3.viewsets.TeamViewSet import TeamDashboardViewSet, TeamProjectsViewSet, subscriptions
...
team_dashboard_urlpatterns = [
    ...
    url(r'^api/subscriptions/(?P<org_id>\d+)/$', subscriptions, name='subscriptions'),
