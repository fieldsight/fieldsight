...
#
# from .views import subscribe_view, stripe_webhook, TeamSettingsView, update_card, finish_subscription, get_package, email
#
# urlpatterns = [
...
#     url(r'^email/$', email, name='team_settings'),
#
# ]