...
from .views import subscribe_view, stripe_webhook, TeamSettingsView, update_card, finish_subscription, get_package, update_plan
...
urlpatterns = [
    ...
    url(r'^update-plan/(?P<org_id>\d+)/$', update_plan, name='update_plan'),
