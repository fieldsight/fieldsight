...
class Stage(models.Model):
    ...
    def get_sub_stage_list(self, sync_details=False):
        if not self.stage:
            ...
            if sync_details:
                return qs.filter(stage_forms__sync_schedule__isnull=False).only('stage_forms__id','name','stage_id', 'stage_forms__xf__id_string', 'stage_forms__xf__user__username', 'stage_forms__sync_schedule__id', 'stage_forms__sync_schedule__schedule', 'stage_forms__sync_schedule__day')
