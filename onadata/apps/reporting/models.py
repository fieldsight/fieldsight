...
INDIVIDUAL_FORM_METRICS_DATA = [
      ...
      {'code': 'form_no_pending_submissions_current', 'label': _('Number of Pending Submissions (Current)'), 'types': [0, 1, 2, 3, 4, 5],
       'category': 'individual_form'},
      {'code': 'form_no_approved_submissions_current', 'label': _('Number of Approved Submissions (Current)'), 'types': [0, 1, 2, 3, 4, 5],
       'category': 'individual_form'},
      {'code': 'form_no_flagged_submissions_current', 'label': _('Number of Flagged Submissions (Current'), 'types': [0, 1, 2, 3, 4, 5],
       'category': 'individual_form'},
