    ...
    try:
        ...
        with transaction.atomic():
            ...
            for site in old_sites_dict:
                ...
                location = Point(round(float(site.get('longitude')), 6), 
                                 round(float(site.get('latitude')), 6), 
                                 srid=4326)
            ...
            for site in new_sites_dict:
                ...
                location = Point(round(float(site.get('longitude')), 6), round(float(site.get('latitude')), 6),
                                 srid=4326)
                site_obj.location = location
