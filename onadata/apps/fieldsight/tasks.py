    ...
    try:
        ...
        for question in meta_ques:
            if not question['question_type'] == 'Link':
                ...
                link_metas = question.metas
                for link_question in link_metas:
                    if not link_question['question_type'] == 'Link':
                        header_columns += [{'id': question_name + "/" + link_question['question_name'], 'name':  question_name + "/" +  link_question['question_name']}]
