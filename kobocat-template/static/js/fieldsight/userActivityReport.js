...
window.app = new Vue({
  ...
  template: `
        ...
        <div class="modal-body p-3">
          <div class="form-group">
            <h5>Activity Report</h5>
              <div class="text-center">
                ...
                <p>
                  Export of User Activities <br> in a selected time interval.
                </p>
              </div>
          ...
          <div class="form-item-wrapper checkbox-listing">
              ...
              <button type="button" :disabled="buttonDisabled" @click="generateUserActivityReport()" class="btn btn-success"> Generate Excel</button>
          </div>
        </div>
  ...
  methods:{
    ...
    generateUserActivityReport : function (){
    ...
    body = {'startdate': this.date1, 'enddate': this.date2}
    
    console.log(body)
    this.$http.post(configure_settings.genarete_user_activity_report_url, body, options).then(successCallback, errorCallback);     
    },
  }
})