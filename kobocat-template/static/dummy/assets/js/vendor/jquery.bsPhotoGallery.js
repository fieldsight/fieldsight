(function($) {
  ...
  $.fn.bsPhotoGallery = function(options) {
      ...
      function createModalWrap(){
        ...
        modal += '<div class="modal-dialog"><div class="modal-content modal-lg">';
        modal += '<div class="modal-header"><h6 class="modal-title">&nbsp;</h6><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>';
      ...
      function showModal(){
          ...
          var title = $(this).find('.bspImgWrapper').attr('img-title');
          ...
          html += '</div>';
            ...
            html += '<a class="bsp-controls next btn btn-sm btn-primary" data-bsp-id="'+clicked.ulId+'" href="'+ (clicked.nextImg) + '">';
            ...
            html += '<i class="la la-long-arrow-right"></i></a>';
            html += '<a class="bsp-controls previous btn btn-sm btn-primary" data-bsp-id="'+clicked.ulId+'" href="' + (clicked.prevImg) + '">'; 
            ...
            html += '<i class="la la-long-arrow-left"></i></a>';
          }
          $('#bsPhotoGalleryModal .modal-header .modal-title').html(title);
      ...
      function nextPrevHandler(){
          ...
          var nextTitle = ul.find('li[data-bsp-li-index="'+index+'"] .bspImgWrapper').attr('img-title');    
           
          var src = getSrcfromStyle(istr);
          var pText = ul.find('li[data-bsp-li-index="'+index+'"] p').html();             
          var modalText = typeof pText !== 'undefined' ? pText : 'undefined';

          $('#bsPhotoGalleryModal .modal-header .modal-title').html(nextTitle);
      ...
      this.each(function(i){
        ...
        items.each(function(x){
          ...
          var theTitle = $(this).find('img').attr('img-title');
          ...
          theImg.wrap('<div class="bspImgWrapper" style="background:url(\''+src+'\');" img-title="'+theTitle+'"></div>');
